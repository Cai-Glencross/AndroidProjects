package hu.cai.ait.todoinflatordemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void savePressed(Button btn){
        final View viewTodo = getLayoutInflater().inflate(R.layout.layout_todo, null);

        TextView tvTodo = (TextView) viewTodo.findViewById(R.id.tvTodo);
        tvTodo.setText(etTodo.getText().toString());

        Button btnDel = (Button) viewTodo.findViewById(R.id.btnDeleter);
